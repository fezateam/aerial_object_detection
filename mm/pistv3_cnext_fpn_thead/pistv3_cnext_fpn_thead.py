...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/pistv3/train/pistv3train.json',
        img_prefix=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/pistv3/train/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(640, 360), keep_ratio=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/pistv3/valid/pistv3val.json',
        img_prefix=
        '/home/akay/Masaüstü/mm/mmdetection/datasets/pistv3/valid/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
classes = ('uap', 'uai')
work_dir = './work_dirs/pistv3_cnext_fpn_thead'
auto_resume = False
gpu_ids = [0]
