...
default_hooks = dict(
    ...
    param_scheduler=dict(
        ...
        max_epochs=100),
    checkpoint=dict(
        type='CheckpointHook', interval=2, save_best='auto', max_keep_ckpts=2),
...
data_root = 'data/pistv3/'
train_ann_file = 'train/pistv3train.json'
train_data_prefix = 'train/images/'
val_ann_file = 'valid/pistv3val.json'
val_data_prefix = 'valid/images/'
class_name = ('uap', 'uai')
num_classes = 2
metainfo = dict(classes=('uap', 'uai'), palette=[(220, 20, 60), (60, 20, 220)])
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='data/pistv3/',
        ann_file='train/pistv3train.json',
        metainfo=dict(
            classes=('uap', 'uai'), palette=[(220, 20, 60), (60, 20, 220)]),
...
val_evaluator = dict(
    ...
    ann_file='data/pistv3/valid/pistv3val.json',
    metric='bbox')
test_evaluator = dict(
    type='mmdet.CocoMetric',
    proposal_nums=(100, 1, 10),
...
launcher = 'none'
work_dir = './work_dirs/yolov8_main_s'
